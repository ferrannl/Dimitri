...
public:
	...
	void create_sprite(float x, float y, float z, float height, float width, const char* path, const float angle, Graphics::Enums::FlipEnum flipstatus, bool is_dynamic);
