...
namespace Game {
	namespace Commands {
		LevelPauseCommand::LevelPauseCommand(const std::shared_ptr<Controllers::MainController> main_controller) : Command(main_controller) {}

		void LevelPauseCommand::execute()
		{
