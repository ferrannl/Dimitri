...
{
	_state = "default";
	add_texture("default", std::make_shared<Graphics::Models::Sprite>(0, 0, 1, 75, 75, 0, Utility::Helpers::get_base_path() + std::string{ "/assets/images/ground.png" }, Graphics::Enums::FlipEnum::NONE));
