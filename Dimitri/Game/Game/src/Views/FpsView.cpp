...
namespace Game {
	...
	void Views::FpsView::draw()
	{
		...
		_textures.push_back(std::make_shared<Graphics::Models::Text>(fps, color, window_width - width - 5, window_height - height, 100, height, width, 0, path, true, Graphics::Models::Center{ 0, 0 }));
