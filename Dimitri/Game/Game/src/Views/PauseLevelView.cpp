...
namespace Game {
	...
	void Views::PauseLevelView::init_textures()
	{
		...
		_textures.push_back(std::make_shared<Graphics::Models::Text>("Pause", color, window_width / 2 - (20 * 5 / 2), window_height / 2 + bg_height /2 - 125, 5, 50, 20 * 5, 0, path, true, Graphics::Models::Center{ 0,0 }, false));
