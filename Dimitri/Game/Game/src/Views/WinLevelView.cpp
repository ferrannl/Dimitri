...
namespace Game {
	...
	void Views::WinLevelView::init_textures()
	{
		...
		_textures.push_back(std::make_shared<Graphics::Models::Text>("Level Complete", color, window_width / 2 - (20 * 14 / 2), window_height / 2 + bg_height / 2 - 125, 5, 50, 20 * 14, 0, path, true, Graphics::Models::Center{ 0,0 }, false));
