...
namespace Game {
	...
	void Views::WinLevelView::init_textures()
	{
		...
		_textures.push_back(std::make_shared<Graphics::Models::Text>("win", color, 0, 0, 5000, win_text_height, win_text_width, 0, font_path, true, Graphics::Models::Center{ 0, 0 }));
	}
