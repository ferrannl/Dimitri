...
namespace Game {
	...
	void Controllers::HomeController::load_buttons()
	{
		...
		std::vector<std::pair<std::string, Enums::ButtonEnum>> button_map{ { "Play", Enums::ButtonEnum::START }, { "Highscore", Enums::ButtonEnum::HIGHSCORE },{ "Savegames", Enums::ButtonEnum::SAVE_GAMES },{ "Help", Enums::ButtonEnum::HELP },{ "Credits", Enums::ButtonEnum::CREDITS }, { "Exit", Enums::ButtonEnum::EXIT } };
