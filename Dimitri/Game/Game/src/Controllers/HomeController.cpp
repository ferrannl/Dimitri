...
namespace Game {
	...
	void Controllers::HomeController::load_buttons()
	{
		...
		std::vector<std::pair<std::string, Enums::ButtonEnum>> button_map{ { "Play", Enums::ButtonEnum::SAVE_GAMES },{ "Help", Enums::ButtonEnum::HELP },{ "Credits", Enums::ButtonEnum::CREDITS },{ "Cheats", Enums::ButtonEnum::CHEATS }, { "Exit", Enums::ButtonEnum::EXIT } };
