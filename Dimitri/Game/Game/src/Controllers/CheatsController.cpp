...
void Game::Controllers::CheatsController::initialize_textures(float height, float width)
{
	...
	_textures.push_back(std::make_shared<Graphics::Models::Sprite>(window_width - 240, window_height - 270, 0, 190, 150, 0, Utility::Helpers::get_base_path() + std::string{ "/assets/images/cheats.png" }, Graphics::Enums::FlipEnum::NONE, true, Graphics::Models::Center{ 0,0 }, true));
}
