...
std::shared_ptr<PhysicsCollision::Models::Shape> PhysicsCollision::Controllers::WorldController::create_shape(std::string type, float x, float y, float width, float height, bool is_dynamic)
{
...
std::vector<std::shared_ptr<PhysicsCollision::Models::Shape>> PhysicsCollision::Controllers::WorldController::get_shapes()const {
