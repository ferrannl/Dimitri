...
namespace PhysicsCollision {
	namespace Controllers {
		...
		public:
			...
			std::shared_ptr<PhysicsCollision::Models::Shape> create_shape(const std::string type, const float x, const float y, float width, float height, const bool is_dynamic);
			void destroy_bodies();
			void simulate();
