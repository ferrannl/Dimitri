...
Models::Text::Text(const std::string& text, const Color& color, const float x, const float y, const float z, const float height, const float width, const float angle, const std::string& path, const bool visible, const Models::Center center, const bool is_dynamic) :
	Models::Texture(x, y, z, height, width, angle, path, visible, center, is_dynamic), _text{ text }, _color{ color} {}
